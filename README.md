...
- [asus-wmi](https://github.com/KyleGospo/asus-wmi) - Asus PC WMI hotkey driver (akmod from [ublue-os/akmods copr](https://copr.fedorainfracloud.org/coprs/ublue-os/akmods/))
