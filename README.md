...
- [hid-asus](https://github.com/KyleGospo/hid-asus-kmod) - kernel module providing hid-asus from [ChimeraOS](https://chimeraos.org/) (akmod from [ublue-os/akmods copr](https://copr.fedorainfracloud.org/coprs/ublue-os/akmods/))
